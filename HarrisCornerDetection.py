...
grayrealchess = cv2.cvtColor(real_chess1,cv2.COLOR_BGR2GRAY)
...
gray_3 = np.float32(grayrealchess)


# In[61]:


dst = cv2.cornerHarris(src=gray_3,blockSize=4,ksize=3,k=0.1)
...
real_chess1[dst>0.01*dst.max()] = [0,0,255]
